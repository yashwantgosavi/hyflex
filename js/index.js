...
document.addEventListener("DOMContentLoaded", function () {
  // Get a reference to the Courses link and the Courses Dropdown section.
  const coursesLink = document.getElementById("coursesLink");
  const coursesDropdown = document.getElementById("coursesDropdown");

  // Add a click event listener to the Courses link.
  coursesLink.addEventListener("click", function (event) {
    event.preventDefault(); // Prevent the default behavior of the link (navigating to "#").

    // Toggle the visibility of the Courses Dropdown section.
    if (coursesDropdown.style.display === "none" || coursesDropdown.style.display === "") {
